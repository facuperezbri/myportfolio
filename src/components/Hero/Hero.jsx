...
const Hero = () => (
  <section className='h-[100h] w-[100vw] max-w-full flex flex-col justify-around text-center'>
    <div>
      ...
      <h1 className='font-bold text-[38px] ss:text-[50px] md:text-[70px] xl:text-[100px] m-1 tracking-tight duration-500 fullstack'>Fullstack Developer</h1>
      <h1 className='font-bold text-[38px] ss:text-[50px] md:text-[70px] xl:text-[100px] m-1 tracking-tight strokeme duration-500 hover:text-black'>& UX/UI Designer</h1>
